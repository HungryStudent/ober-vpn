...
👭 Пригласите друзей в наш сервис и получите 50₽ на 
баланс за каждого друга. Ваши друзья получат 100₽ на 
баланс!
...
Теперь давайте настроим ваш VPN. Выберите тип 
вашего устройства:""")
