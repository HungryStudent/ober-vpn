...
В разделе «Мои устройства»:
    WireGuard: Вы можете создать новый конфиг-файл или восстановить существующий в случае его утери;
    Outline: Вы можете проверить остаток трафика, создать новый ключ или восстановить существующий в случае его утери;
